...
class IdentitePersonne(Base):
    ...
    __table_args__ = (
        UniqueConstraint("dossier_id", "numero_cin", name="uq_identite_dossier_cin"),
    )
...
# 
    type_apport_personnel: Mapped[str | None] = mapped_column(String(20), nullable=True)
    montant_apport: Mapped[float | None] = mapped_column(Numeric(14, 2), nullable=True)
# 
