...
class IdentiteDupliqueeError(AppError):
    """Levée si un associé avec le même numéro CIN existe déjà pour ce dossier."""

class IdentiteIntrouvableError(AppError):
    """Levée si l'associé demandé n'existe pas pour ce dossier."""